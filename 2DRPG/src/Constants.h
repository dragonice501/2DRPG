...
const int BATTLE_PARTY_UI_WIDTH = 300;
const int BATTLE_PARTY_UI_HEIGHT = 130;
const int BATTLE_PARTY_UI_BUFFER = 10;
const int BATTLE_TEXT_VERTICAL_PADDING = 30;
const int BATTLE_CURSOR_SCALE = 2;
const int BATTLE_ATTACK_UI_WIDTH = 200;
const int BATTLE_ATTACK_UI_HEIGHT = 50;